...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdos Inscritos Ellen:" + devEllen.getConteudosInscritos());
        devEllen.progredir();
        devEllen.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos Ellen:" + devEllen.getConteudosInscritos());
        System.out.println("Conteúdos Concluídos Ellen:" + devEllen.getConteudosConcluidos());
